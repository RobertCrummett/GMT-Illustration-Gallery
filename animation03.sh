#!/usr/bin/env bash
# Copied and pasted from the source repo because I could
# not find an error in my attempt!
...
# 5. Run the movie
gmt movie main.sh -Iin.sh -Sbpre.sh -C${canvas_width}cx${canvas_height}cx80 -Tdates_vs_goals.txt -NMessiGoals -H2 -Ml,png -Vi -Zs -Gblack -K+fo+p \
